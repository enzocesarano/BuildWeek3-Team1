...
const Sidebar = ({ myProfile }) => {
  ...
  const Consigliati = [
    ...
    {
      id: 2,
      name: "Vladimir Durante",
      role: "Analista informatico, Programmatore",
      connections: "3°+",
    },
    {
      id: 3,
      name: "Simone Di Giovambattista",
      role: "Cyber Security Senior Consultant at EY",
      connections: "3°+",
    },
  ];
  ...
  const potrestiConoscere = [
    ...
    {
      id: 3,
      name: "Lucrezia Baldonero",
      role: "Business Developer presso ELIS",
    },
  ];
        ...
        <Card.Body>
          ...
          {arrayAllProfiles2.map((element) => {
            if (element._id === idLocation) {
              return <p key={element._id}>www.linkedin.com/in/{element.username}</p>;
            }
          })}
        </Card.Body>
      </Card>
